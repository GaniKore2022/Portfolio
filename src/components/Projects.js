...
function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Built a scalable back-end system with CRUD operations to manage employee data using Spring Boot. Secured endpoints with Spring Security and implemented role-based and permission-based access control. Integrated Swagger for interactive API documentation. Wrote unit and integration tests using JUnit and Mockito to ensure code quality and reliability"
    }
  ];
